...
public class OverviewMountHua extends JFrame {
    public OverviewMountHua() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > Retrun of The Mount Hua Sect</span></html>");
    ...
    public static void main(String[] args) {
        OverviewMountHua overviewMountHua = new OverviewMountHua();
        overviewMountHua.setVisible(true);
    }
}
