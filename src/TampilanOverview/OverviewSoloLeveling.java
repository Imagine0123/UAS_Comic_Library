...
public class OverviewSoloLeveling extends JFrame {
    public OverviewSoloLeveling() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/Poster3.png")));
        ...
        JLabel Teks1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Followed By 10364 Peoples</span></html>");
        Teks1.setForeground(Color.WHITE);
        Teks1.setBounds(370, 160, 1000, 100);
        latarinformasi.add(Teks1, Integer.valueOf(1));

        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Solo Leveling</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> The story follows Sung Jin-Woo, an E-rank Hunter known as the \"World's Weakest,\" who risks his life <br> " +
                "in low-level dungeons to make ends meet. After stumbling upon a hidden, extremely difficult <br> " +
                "dungeon, he nearly dies but gains a mysterious power: a personal quest log that allows him to level" +
                "<br> up. By training and hunting monsters, Jin-Woo transforms from the weakest Hunter into an" +
                "<br> unstoppable S-rank Hunter.</span></html>");
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> 추공 (Chugong)</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> July 30th 2024</span></html>");
        ...
        JLabel genreLabel4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Shounen</span></html>");
        genreLabel4.setForeground(Color.WHITE);
        genrePanel4.add(genreLabel4);
        latarinformasi.add(genrePanel4, Integer.valueOf(1));

        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> Solo Leveling’s Chapter</span></html>");
        ...
        JLabel genreLabel5 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>System</span></html>");
        ...
        JLabel stts1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Status Completed</span></html>");
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 200");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > Solo Leveling</span></html>");
    ...
    public static void main(String[] args) {
        OverviewSoloLeveling overviewSoloLeveling = new OverviewSoloLeveling();
        overviewSoloLeveling.setVisible(true);
    }
}
