...
public class OverviewHeavenlyInquisition extends JFrame {
    public OverviewHeavenlyInquisition() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-5.png")));
        ...
        JLabel Teks1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Followed By 6265 Peoples</span></html>");
        Teks1.setForeground(Color.WHITE);
        Teks1.setBounds(370, 160, 1000, 100);
        latarinformasi.add(Teks1, Integer.valueOf(1));

        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Heavenly Inquisition Sword\n</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> By Redice Studios, the ones who brought you Return of the Disaster-Class Hero and Solo <br> " +
                "Leveling! \"He is the master of the Nine Heavens.\" Yeon Jeokha was the child of a second wife. <br> " +
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Cho Jinhaeng</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> November 21st 2024</span></html>");
        ...
        JLabel genreLabel3 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Martial Arts</span></html>");
        ...
        JLabel genreLabel4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Murim</span></html>");
        genreLabel4.setForeground(Color.WHITE);
        genrePanel4.add(genreLabel4);
        latarinformasi.add(genrePanel4, Integer.valueOf(1));

        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> Heavenly Inquisition Sword’s Chapter</span></html>");
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 98");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > Heavenly Inquisition Sword</span></html>");
    ...
    public static void main(String[] args) {
        OverviewHeavenlyInquisition overviewHeavenlyInquisition = new OverviewHeavenlyInquisition();
        overviewHeavenlyInquisition.setVisible(true);
    }
}