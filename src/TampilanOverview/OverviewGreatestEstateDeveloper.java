...
public class OverviewGreatestEstateDeveloper extends JFrame {
    public OverviewGreatestEstateDeveloper() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-4.png")));
        ...
        JLabel Teks1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Followed By 4613 Peoples</span></html>");
        Teks1.setForeground(Color.WHITE);
        Teks1.setBounds(370, 160, 1000, 100);
        latarinformasi.add(Teks1, Integer.valueOf(1));

        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> The Greatest Estate Developer</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> When civil engineering student Suho Kim falls asleep reading a fantasy novel, he wakes up as <br> " +
                "a character in the book! Suho is now in the body of Lloyd Frontera, a lazy noble who loves to <br> " +
                "drink, and whose family is in a mountain of debt. Using his engineering knowledge, Suho" +
                "<br> designs inventions to avert the terrible future that lies in wait for him. With the help of a" +
                "<br> giant hamster, a knight, and the world’s magic, can Suho dig his new family out of debt and" +
                "<br> build a better future?</span></html>");
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> BK_Moon/ Lee hyunmin</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> November 17th 2024</span></html>");
        ...
        JLabel genreLabel4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Comedy</span></html>");
        genreLabel4.setForeground(Color.WHITE);
        genrePanel4.add(genreLabel4);
        latarinformasi.add(genrePanel4, Integer.valueOf(1));

        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> The Greatest Estate Developer’s Chapter</span></html>");
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 168");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > The Greatest Estate Developer</span></html>");
    ...
    public static void main(String[] args) {
        OverviewGreatestEstateDeveloper overviewGreatestEstateDeveloper = new OverviewGreatestEstateDeveloper();
        overviewGreatestEstateDeveloper.setVisible(true);
    }
}
