...
public class OverviewAbsoluteRegression extends JFrame {
    public OverviewAbsoluteRegression() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-7.png")));
        ...
        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Absolute Regression</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> By the Studio that brought you {The Return of the Crazy Demon} and The Artist That brought <br> " +
                "{The Breaker}! <br> " +
                "\"Please send me back to the past.\" If he cannot not kill that person in this era, he just needs" +
                "<br> to go back to the past. The man used the \"Great Regression Technique\" to cross time, going" +
                "<br> back to the past he desired so much. The \"Unrivaled Swordsman\" who had lost everything, his" +
                "<br> family, friends, and life. This is his first step to taking his revenge.</span></html>");
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Jang Yunghoon/ JP</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> November 19th 2024</span></html>");
        ...
        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> Absolute Regression’s Chapter</span></html>");
        ...
        RoundedPanel genrePanel7 = new RoundedPanel();
        genrePanel7.setBounds(370, 555, 60, 20);
        genrePanel7.setBackground(Color.decode("#606060"));
        genrePanel7.setLayout(new FlowLayout(FlowLayout.CENTER, 0, 0));
        JLabel genreLabel7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Revenge</span></html>");
        genreLabel7.setForeground(Color.WHITE);
        genrePanel7.add(genreLabel7);
        latarinformasi.add(genrePanel7, Integer.valueOf(1));
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 23");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > Absolute Regression</span></html>");
    ...
    public static void main(String[] args) {
        OverviewAbsoluteRegression overviewAbsoluteRegression = new OverviewAbsoluteRegression();
        overviewAbsoluteRegression.setVisible(true);
    }
}