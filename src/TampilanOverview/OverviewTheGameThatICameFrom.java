...
public class OverviewTheGameThatICameFrom extends JFrame {
    public OverviewTheGameThatICameFrom() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-8.png")));
        ...
        JLabel Teks1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Followed By 1435 Peoples</span></html>");
        Teks1.setForeground(Color.WHITE);
        Teks1.setBounds(370, 160, 1000, 100);
        latarinformasi.add(Teks1, Integer.valueOf(1));

        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> The Game That I Came From</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> If you max out your level in-game, you can get heaven-defying powers in real life?! Player Ling <br> " +
                "Ce finally obtained this reward through his hard work but ended up receiving the most <br> " +
                "useless skills. Just as he was mourning his luck, a mysterious power brought him back to" +
                "<br> three years in the past. With the experiences and memories of his previous life, how many" +
                "<br> different wonderful things can he bring to his new life?</span></html>");
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> MOKF 黑鸟社</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> November 15th 2024</span></html>");
        ...
        JLabel genreLabel3 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Game</span></html>");
        ...
        JLabel genreLabel4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Rebirth</span></html>");
        genreLabel4.setForeground(Color.WHITE);
        genrePanel4.add(genreLabel4);
        latarinformasi.add(genrePanel4, Integer.valueOf(1));

        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> The Game That I Came From’s Chapter</span></html>");
        ...
        JLabel genreLabel5 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Virtual Reality</span></html>");
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 319");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > The Game That I Came From</span></html>");
    ...
    public static void main(String[] args) {
        OverviewTheGameThatICameFrom overviewTheGameThatICameFrom = new OverviewTheGameThatICameFrom();
        overviewTheGameThatICameFrom.setVisible(true);
    }
}