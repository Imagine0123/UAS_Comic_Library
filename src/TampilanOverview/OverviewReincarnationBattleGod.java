...
public class OverviewReincarnationBattleGod extends JFrame {
    public OverviewReincarnationBattleGod() {
        setTitle("Overview");
        setSize(1440, 1024);
    ...
    private void overview(){
        ...
        ImageIcon PosterNano = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/Poster4.png")));
        ...
        JLabel Teks1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Followed By 5421 Peoples</span></html>");
        Teks1.setForeground(Color.WHITE);
        Teks1.setBounds(370, 160, 1000, 100);
        latarinformasi.add(Teks1, Integer.valueOf(1));

        JLabel Teks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Reincarnation of the Suicidal Battle God\n</span></html>");
        ...
        JLabel Teks4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> A time travel action fantasy of the strongest of mankind. “Even if the disgusting gods gave me <br> " +
                "this chance, an opportunity is still an opportunity. Since they want to end up dead, I will kill <br> " +
                "them.” The last survivor of mankind, Zephyr. The fight with the demons ended in defeat and" +
                "<br> the gods gave him a chance to go back 10 years in time. The demons who took everything" +
                "<br> away from humans and the gods who treated humans as beings for sight-seeing. This time, I" +
                "<br> will tear them to pieces.</span></html>");
        ...
        JLabel Teks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> Blue-Deep</span></html>");
        ...
        JLabel Teks9 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'> December 23rd 2023</span></html>");
        ...
        JLabel genreLabel1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Adventure</span></html>");
        ...
        JLabel genreLabel2 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Fantasy</span></html>");
        ...
        JLabel genreLabel3 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Overpowered</span></html>");
        ...
        JLabel genreLabel4 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Returner</span></html>");
        genreLabel4.setForeground(Color.WHITE);
        genrePanel4.add(genreLabel4);
        latarinformasi.add(genrePanel4, Integer.valueOf(1));

        JLabel Teks11 = new JLabel("<html><span style='font-family:Poppins; font-size:12px; font-weight:bold;'> Reincarnation of the Suicidal Battle God’s Chapter</span></html>");
        ...
        JLabel stts1 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:normal;'>Status Hiatus</span></html>");
        ...
        JLabel lastchapterNumber = new JLabel("Chapter 101");
    ...
    private void background() {
        ...
        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:8px; font-weight:bold;'> NGOMIKMAS! > Reincarnation of the Suicidal Battle God</span></html>");
    ...
    public static void main(String[] args) {
        OverviewReincarnationBattleGod overviewReincarnationBattleGod = new OverviewReincarnationBattleGod();
        overviewReincarnationBattleGod.setVisible(true);
    }
}