...
public class Newest extends JFrame {
    ...
    private void background() {
        ...
        ImageIcon Poster1 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-6.png")));
        ...
        ImageIcon Poster2 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-5.png")));
        ...
        ImageIcon Poster6 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-1.png")));
        ...
        ImageIcon Poster7 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-7.png")));
        ...
        ImageIcon Poster8 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-4.png")));
        ...
        ImageIcon Poster9 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-8.png")));
        ...
        ImageIcon Poster10 = new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/poster-2.png")));
        ...
        JLabel labelTeks2 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Logging 10,000...</span></html>");
        labelTeks2.setForeground(Color.WHITE);
        labelTeks2.setBounds(130, 320, 500, 50);
        latar.add(labelTeks2, Integer.valueOf(1));

        JLabel labelTeks3 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 168</span></html>");
        labelTeks3.setForeground(Color.WHITE);
        labelTeks3.setBounds(130, 325, 1000, 100);
        latar.add(labelTeks3, Integer.valueOf(1));

        JLabel labelTeks4 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Heavenly Inqui...</span></html>");
        labelTeks4.setForeground(Color.WHITE);
        labelTeks4.setBounds(300, 320, 500, 50);
        latar.add(labelTeks4, Integer.valueOf(1));

        JLabel labelTeks5 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 97</span></html>");
        labelTeks5.setForeground(Color.WHITE);
        labelTeks5.setBounds(300, 325, 1000, 100);
        latar.add(labelTeks5, Integer.valueOf(1));

        JLabel labelTeks6 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Nano Machine</span></html>");
        labelTeks6.setForeground(Color.WHITE);
        labelTeks6.setBounds(470, 320, 500, 50);
        latar.add(labelTeks6, Integer.valueOf(1));

        JLabel labelTeks7 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 234</span></html>");
        labelTeks7.setForeground(Color.WHITE);
        labelTeks7.setBounds(470, 325, 1000, 100);
        latar.add(labelTeks7, Integer.valueOf(1));

        JLabel labelTeks8 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Absolute Regre...</span></html>");
        labelTeks8.setForeground(Color.WHITE);
        labelTeks8.setBounds(640, 320, 500, 50);
        latar.add(labelTeks8, Integer.valueOf(1));

        JLabel labelTeks9 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 22</span></html>");
        labelTeks9.setForeground(Color.WHITE);
        labelTeks9.setBounds(640, 325, 1000, 100);
        latar.add(labelTeks9, Integer.valueOf(1));

        JLabel labelTeks10 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Greatest Es...</span></html>");
        labelTeks10.setForeground(Color.WHITE);
        labelTeks10.setBounds(130, 550, 500, 50);
        latar.add(labelTeks10, Integer.valueOf(1));

        JLabel labelTeks11 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 168</span></html>");
        labelTeks11.setForeground(Color.WHITE);
        labelTeks11.setBounds(130, 555, 1000, 100);
        latar.add(labelTeks11, Integer.valueOf(1));

        JLabel labelTeks12 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> The Game That...</span></html>");
        labelTeks12.setForeground(Color.WHITE);
        labelTeks12.setBounds(300, 550, 500, 50);
        latar.add(labelTeks12, Integer.valueOf(1));

        JLabel labelTeks13 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 319</span></html>");
        labelTeks13.setForeground(Color.WHITE);
        labelTeks13.setBounds(300, 555, 1000, 100);
        latar.add(labelTeks13, Integer.valueOf(1));

        JLabel labelTeks14 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Return Of T...</span></html>");
        labelTeks14.setForeground(Color.WHITE);
        labelTeks14.setBounds(470, 550, 500, 50);
        latar.add(labelTeks14, Integer.valueOf(1));

        JLabel labelTeks15 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 149</span></html>");
        labelTeks15.setForeground(Color.WHITE);
        labelTeks15.setBounds(470, 555, 1000, 100);
        latar.add(labelTeks15, Integer.valueOf(1));

        JLabel labelTeks16 = new JLabel("<html><span style='font-family:Poppins; font-size:14px; font-weight:bold;'> Solo Level...</span></html>");
        labelTeks16.setForeground(Color.WHITE);
        labelTeks16.setBounds(640, 550, 500, 50);
        latar.add(labelTeks16, Integer.valueOf(1));

        JLabel labelTeks17 = new JLabel("<html><span style='font-family:Poppins; font-size:10px; font-weight:normal;'> Chapter 200</span></html>");
